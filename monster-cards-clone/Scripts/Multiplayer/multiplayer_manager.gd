...
func request_enemy_card_selection(player_id: int) -> void:
	multiplayer_interface.request_enemy_card_selection(player_id)


func _on_multiplayer_interface_select_enemy_card() -> void:
	select_enemy_card.emit()
